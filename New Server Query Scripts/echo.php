...
if($folderName == "Levels")
{
	...
	$checkQuery = "SELECT published FROM puzzles WHERE USER_ID=$userid AND puzzle='$puzzle' AND published='1'";
	...
	{
		$query = "INSERT INTO puzzles(user, USER_ID, description, puzzle, published, timeStamp)  VALUES('$user', '$userid', '$description','$puzzle', 0, NOW()) 

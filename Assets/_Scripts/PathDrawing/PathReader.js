...
@script RequireComponent(PathDrawer);

/**
* This script will read in path data from a CSV file (in Barry Datacord format) and prompt the user which level
* to view paths for. It will then send the information to a PathDrawer and a World Manager for visualization
*/
...
//The path drawer
@HideInInspector var pathDrawer : PathDrawer;
